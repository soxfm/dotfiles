...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1584478947);
user_pref("app.update.lastUpdateTime.background-update-timer", 1584477789);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1584410610);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1584483820);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1584482671);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1584482551);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1584478827);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1579665934);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1584410730);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1584485621641");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1584487416641");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1584484697790");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1584488297790");
...
user_pref("browser.startup.lastColdStartupCheck", 1584476590);
...
user_pref("idle.lastDailyNotification", 1584477774);
...
user_pref("media.gmp-manager.lastCheck", 1584477614);
...
user_pref("places.database.lastMaintenance", 1584477774);
...
user_pref("services.blocklist.addons.checked", 1584479022);
user_pref("services.blocklist.gfx.checked", 1584479022);
user_pref("services.blocklist.pinning.checked", 1584479022);
user_pref("services.blocklist.plugins.checked", 1584479022);
user_pref("services.settings.clock_skew_seconds", -76);
user_pref("services.settings.last_etag", "\"1584481831273\"");
user_pref("services.settings.last_update_seconds", 1584485000);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1584479022);
user_pref("services.settings.main.cfr-fxa.last_check", 1584479022);
user_pref("services.settings.main.cfr.last_check", 1584479022);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1584479022);
user_pref("services.settings.main.hijack-blocklists.last_check", 1584479022);
user_pref("services.settings.main.language-dictionaries.last_check", 1584479022);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1584482000);
user_pref("services.settings.main.public-suffix-list.last_check", 1584479022);
user_pref("services.settings.main.sites-classification.last_check", 1584479022);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1584479022);
user_pref("services.settings.main.whats-new-panel.last_check", 1584479022);
user_pref("services.settings.security.onecrl.checked", 1584479022);
...
user_pref("toolkit.startup.last_success", 1584476588);
