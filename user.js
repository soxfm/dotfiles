...
user_pref("app.update.lastUpdateTime.addon-background-update-timer", 1584072384);
user_pref("app.update.lastUpdateTime.background-update-timer", 1584138263);
user_pref("app.update.lastUpdateTime.blocklist-background-update-timer", 1584072504);
user_pref("app.update.lastUpdateTime.browser-cleanup-thumbnails", 1584138383);
user_pref("app.update.lastUpdateTime.recipe-client-addon-run", 1584138143);
user_pref("app.update.lastUpdateTime.search-engine-update-timer", 1584138023);
user_pref("app.update.lastUpdateTime.services-settings-poll-changes", 1584072264);
user_pref("app.update.lastUpdateTime.telemetry_modules_ping", 1579665934);
user_pref("app.update.lastUpdateTime.xpi-signature-verification", 1584072624);
user_pref("beacon.enabled", false);
user_pref("browser.aboutConfig.showWarning", false);
user_pref("browser.bookmarks.editDialog.confirmationHintShowCount", 289);
...
user_pref("browser.safebrowsing.provider.google4.lastupdatetime", "1584137996229");
user_pref("browser.safebrowsing.provider.google4.nextupdatetime", "1584139785229");
user_pref("browser.safebrowsing.provider.mozilla.lastupdatetime", "1584137998271");
user_pref("browser.safebrowsing.provider.mozilla.nextupdatetime", "1584141598271");
...
user_pref("browser.startup.lastColdStartupCheck", 1584137993);
user_pref("browser.tabs.opentabfor.middleclick", false);
user_pref("browser.tabs.warnOnClose", false);
user_pref("browser.ui.zoom.force-user-scalable", true);
user_pref("browser.uiCustomization.state", "{\"placements\":{\"widget-overflow-fixed-list\":[\"library-button\"],\"nav-bar\":[\"back-button\",\"forward-button\",\"sidebar-button\",\"stop-reload-button\",\"urlbar-container\",\"downloads-button\",\"jid1-mnnxcxisbpnsxq_jetpack-browser-action\",\"jid1-bofifl9vbdl2zq_jetpack-browser-action\",\"https-everywhere_eff_org-browser-action\",\"ublock0_raymondhill_net-browser-action\"],\"TabsToolbar\":[\"tabbrowser-tabs\",\"new-tab-button\",\"alltabs-button\"],\"PersonalToolbar\":[]},\"seen\":[\"developer-button\",\"ublock0_raymondhill_net-browser-action\",\"https-everywhere_eff_org-browser-action\",\"jid1-mnnxcxisbpnsxq_jetpack-browser-action\",\"jid1-bofifl9vbdl2zq_jetpack-browser-action\"],\"dirtyAreaCache\":[\"nav-bar\",\"TabsToolbar\",\"PersonalToolbar\",\"widget-overflow-fixed-list\"],\"currentVersion\":16,\"newElementCount\":6}");
...
user_pref("idle.lastDailyNotification", 1584072295);
...
user_pref("media.gmp-manager.lastCheck", 1584081685);
...
user_pref("places.database.lastMaintenance", 1583806584);
...
user_pref("services.blocklist.addons.checked", 1584133637);
user_pref("services.blocklist.gfx.checked", 1584133637);
user_pref("services.blocklist.pinning.checked", 1584072336);
user_pref("services.blocklist.plugins.checked", 1584133637);
user_pref("services.settings.clock_skew_seconds", -222);
user_pref("services.settings.last_etag", "\"1584127834420\"");
user_pref("services.settings.last_update_seconds", 1584133637);
user_pref("services.settings.main.anti-tracking-url-decoration.last_check", 1584133637);
user_pref("services.settings.main.cfr-fxa.last_check", 1584133637);
user_pref("services.settings.main.cfr.last_check", 1584133637);
user_pref("services.settings.main.fxmonitor-breaches.last_check", 1584133637);
user_pref("services.settings.main.hijack-blocklists.last_check", 1584133637);
user_pref("services.settings.main.language-dictionaries.last_check", 1584133637);
user_pref("services.settings.main.normandy-recipes-capabilities.last_check", 1584133637);
user_pref("services.settings.main.public-suffix-list.last_check", 1584133637);
user_pref("services.settings.main.sites-classification.last_check", 1584133637);
user_pref("services.settings.main.url-classifier-skip-urls.last_check", 1584133637);
user_pref("services.settings.main.whats-new-panel.last_check", 1584133637);
user_pref("services.settings.security.onecrl.checked", 1584072336);
...
user_pref("toolkit.startup.last_success", 1584137992);
